...
Use Node.js 22+, FFmpeg/ffprobe and PostgreSQL (or the development-only PGlite mode). Keep provider keys outside the repository. Run the README check commands before proposing changes.
